...
- [Ограничения групп](https://github.com/Iksix/Iks_Admin/tree/master?tab=readme-ov-file#%D0%BE%D0%B3%D1%80%D0%B0%D0%BD%D0%B8%D1%87%D0%B5%D0%BD%D0%B8%D1%8F-%D0%B3%D1%80%D1%83%D0%BF%D0%BF-groups_limitations)
- [Сортировка/настройка пунктов меню](https://github.com/Iksix/Iks_Admin/tree/master?tab=readme-ov-file#%D1%81%D0%BE%D1%80%D1%82%D0%B8%D1%80%D0%BE%D0%B2%D0%BA%D0%B0%D0%BD%D0%B0%D1%81%D1%82%D1%80%D0%BE%D0%B9%D0%BA%D0%B0-%D0%BF%D1%83%D0%BD%D0%BA%D1%82%D0%BE%D0%B2-%D0%BC%D0%B5%D0%BD%D1%8E)
---
# Особенности
...
- Вывод причины кика/бана игроку после выдачи наказания <br>
![alt text](docs/image-4.png) <br>
...
Запись с ограничением выглядит так: <br>
...
```
Допустим я хочу убрать из меню возможность заблокировать сразу оба чата <br>
![alt text](docs/image-1.png) <br>
Для этого:
```json
...
```
После добавления настройки в `sortmenus.json` получаем: <br>
![alt text](docs/image-3.png) <br>
### Как узнать ID меню и пунктов?
Для этого нужно включить `DebugMode` в конфиге плагина `core.json`
После этого при открытии меню будут отображаться данные о нём: <br>
![alt text](docs/image-2.png)  <br>
- Красным цветом подчёркнуто - ID меню
- Зелёным - ID пункта <br>
